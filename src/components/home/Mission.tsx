  ...
  return (
    <section className="section-padding bg-navy-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-20">
        <div className="absolute top-10 left-10 w-32 h-32 rounded-full bg-gold/10 blur-2xl"></div>
        <div className="absolute bottom-10 right-10 w-64 h-64 rounded-full bg-gold/10 blur-3xl"></div>
      </div>
      
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="text-2xl md:text-4xl mb-8 animate-fade-in-up">Our <span className="text-gold">Mission</span></h2>
